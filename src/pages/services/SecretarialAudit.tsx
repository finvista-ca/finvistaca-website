...
export const SecretarialAudit: React.FC<SecretarialAuditProps> = ({ service, relatedServices }) => {
  const pageData: ServicePageData = {
    ...
    faqs: [{ q: "Who can be appointed as a Secretarial Auditor?", a: "Only members of the ICSI holding a valid certificate of practice can conduct a Secretarial Audit." },
