...
export const TaxAudit: React.FC<TaxAuditProps> = ({ service, relatedServices }) => {
  const pageData: ServicePageData = {
    ...
    faqs: [{ q: "What is the penalty for delay in filing a tax audit report?", a: "The penalty is 0.5% of the total sales, turnover, or gross receipts, subject to a maximum of Rs 1,50,000." },
