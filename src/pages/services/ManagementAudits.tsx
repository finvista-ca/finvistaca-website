...
export const ManagementAudits: React.FC<ManagementAuditsProps> = ({ service, relatedServices }) => {
  const pageData: ServicePageData = {
    ...
    faqs: [{ q: "What is the focus of a Management Audit?", a: "It focuses on analyzing the health of company management, evaluating decisions, policies, and operational efficiency." },
